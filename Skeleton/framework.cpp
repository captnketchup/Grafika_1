...
#else
	glutInitDisplayMode(GLUT_RGBA | GLUT_DOUBLE | GLUT_DEPTH);		// //using GLUT_DOUBLE for buffering two images (no villodzás), GLUT_DEPTH how far is eaid pixel from camera 
#endif
